...
function subjectColour(subject: string) {
  return subjectColourClasses[subject] ?? 'bg-slate-400';
}
  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        <div
          className={`flex h-24 w-24 shrink-0 items-center justify-center rounded-2xl border-2 border-slate-950 ${tutor.avatarColour} text-3xl font-black shadow-[3px_3px_0_#0f172a]`}
        >
          {initials(tutor.name)}
        </div>
