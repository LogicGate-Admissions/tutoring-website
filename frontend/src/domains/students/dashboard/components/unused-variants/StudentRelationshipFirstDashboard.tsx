...
/**
 * Version A: relationship-first student dashboard.
 *
...
type Section = 'my-tutors' | 'learning-profile' | 'find-tutors';

const tabs: Array<{ id: Section; label: string; description: string }> = [
  {
    id: 'my-tutors',
    label: 'My tutors',
    description: 'Tutor-first support',
  },
  {
    id: 'learning-profile',
...
export function StudentRelationshipFirstDashboard() {
